            ...
            <form action="{{ route('admin.banner.update',['id' =>$banner->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="relative flex items-center mt-2">
                        ...
                        <input type="text" placeholder="Slogan.." name="slogan" class="block w-full py-2.5 text-gray-700 placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5   focus:border-indigo-400 focus:ring-indborder-indigo-300 focus:outline-none focus:ring focus:ring-opacity-40" value="{{ old('slogan') ? old('slogan') : $banner->slogan }}">
                    </div>
                ...
                <div class="form-group my-3">
                    ...
                    <div class="relative flex items-center mt-2">
                        ...
                        <input type="url" placeholder="Link..." name="link" class="block w-full py-2.5  placeholder-gray-400/70 bg-white border border-gray-200 rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5 text-blue-500  focus:border-indigo-400 focus:ring-indborder-indigo-300 focus:outline-none focus:ring focus:ring-opacity-40" value="{{ old('link') ? old('link') : $banner->link }}">
                    </div>
                    <span class="mt-2 text-xs text-red-500">
                        @error('link')
                        {{ $message }}
                ...
                @else
                <img src="{{ Storage::url($banner->image) }}" alt="banner-image" class="w-auto h-28 mt-2 rounded-md shadow-md" id="banner" />
                @endif
                @error('image')
