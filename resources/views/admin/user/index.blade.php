...
<main class="w-full px-3 mx-auto sm:px-5">
    ...
    <form method="get" action="" class="flex flex-wrap items-center justify-between mt-6">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('admin.user.deleted') }}" class="flex items-center gap-2 px-3 py-2 text-xs font-medium text-white transition-all duration-300 bg-red-500 font-montserrat rounded-xl hover:bg-red-500" style="box-shadow: 0 15px 30px -5px rgba(229, 70, 70, 0.6);"><span class="hidden sm:block">Tài khoản đã xóa</span>
                                    ...
                                    <div class="z-50 dropdown dropdown-left dropdown-end">
                                        ...
                                        <ul tabindex="0" class="z-50 bg-white shadow dropdown-content rounded-xl">
                                            <div class="p-2 text-sm text-gray-500 bg-white border border-gray-100 w-fit rounded-xl">
                                                <ul class="space-y-1">
                                                    <li>
                                                        <a href="{{ route('admin.user.profile',['id' =>$user->id]) }}" class="flex items-center gap-3 p-1 rounded-md hover:bg-gray-100 text-[#000000]">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('admin.user.profile.update',['id' =>$user->id]) }}" class="flex items-center gap-3 p-1 rounded-md hover:bg-gray-100 text-[#000000]">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-black">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('admin.user.account.update',['id' =>$user->id]) }}" class="flex items-center gap-3 p-1 rounded-md hover:bg-gray-100 text-[#000000]">
                                                    ...
                                                    <li>
                                                        <form action="{{ route('admin.user.delete',['id' =>$user->id]) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button data-id="{{ $user->id }}" type="submit" class="flex items-center gap-3 p-1 text-red-500 rounded-md hover:bg-red-100 hover:text-white delete__user-btn">
