                ...
                <div class="relative w-full">
                    <div class="relative -top-40 bg-white dark:bg-slate-900 lg:px-8 px-6 py-10 rounded-xl shadow-lg dark:shadow-gray-700 overflow-hidden">
                        <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                            <div class="ltr:md:text-left rtl:md:text-right text-center z-1">
                                <h3 class="md:text-3xl text-2xl md:leading-normal leading-normal font-medium text-black dark:text-white">Đăng ký nhận tin</h3>
                                <p class="text-slate-400 max-w-xl mx-auto">Đăng ký để nhận thông tin mới nhất từ chúng tôi</p>
                            </div>

                            <div class="subcribe-form z-1">
                                <form class="relative max-w-lg md:ms-auto">
                                    <input type="email" id="subcribe" name="email" class="rounded-full bg-white dark:bg-slate-900 shadow dark:shadow-gray-700" placeholder="Địa chỉ email của bạn...">
                                    <button type="submit" class="btn bg-green-600 hover:bg-green-700 text-white rounded-full">Đăng ký</button>
                                </form>
                                <!--end form-->
                            </div>
                        </div>
                    ...
                    <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px] -mt-24">
                        <div class="lg:col-span-4 md:col-span-12">
                            ...
                            <p class="mt-6 text-gray-300">Nhà gì cũng có mua hết ở LCT NEWS</p>

                        </div>
                        <!--end col-->

                        <div class="lg:col-span-2 md:col-span-4 mr-5">
                            <h5 class="tracking-[1px] text-gray-100 font-semibold">Hướng dẫn</h5>
                            <ul class="list-none footer-list mt-6 whitespace-nowrap">
                                <li><a href="aboutus.html" class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Về chúng tôi</a></li>

                                <li class="mt-[10px]"><a href="features.html" class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Báo giá & hỗ trợ</a></li>

                                <li class="mt-[10px]"><a href="pricing.html" class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Câu hỏi thường gặp</a></li>

                                <li class="mt-[10px]"><a href="blog.html" class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Góp ý báo lỗi</a></li>

                            </ul>
                        </div>
                        <!--end col-->

                        <div class="lg:col-span-3 md:col-span-4 whitespace-nowrap">
                            <h5 class="tracking-[1px] text-gray-100 font-semibold">Chính sách và điều khoản</h5>
                            <ul class="list-none footer-list mt-6 whitespace-nowrap">
                                <li><a href="terms.html" class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i>Điều khoản dịch vụ</a></li>
                                <li class="mt-[10px]"><a href="privacy.html" class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i>Quy định đăng tin</a></li>
                                <li class="mt-[10px]"><a href="listing-one.html" class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i>Điều khoản thỏa thuận</a></li>
                                <li class="mt-[10px]"><a href="contact.html" class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Chính sách bảo mật</a></li>
                        ...
                        <div class="lg:col-span-3 md:col-span-4">
                            ...
                            <div class="flex mt-6">
                                ...
                                <div class="">
                                    <a href="mailto:contact@example.com" class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out">congiendev@gmail.com</a>
                                </div>
                            </div>
                            ...
                            <div class="flex mt-6">
                                ...
                                <div class="">
                                    <a href="tel:0965067842" class="text-slate-300 hover:text-slate-400 duration-500 ease-in-out">+84 96 506 7842</a>
                                </div>
                            </div>
                        </div>
                        <!--end col-->
            ...
            <div class="grid md:grid-cols-2 items-center gap-6">
                <div class="ltr:md:text-left rtl:md:text-right text-center">
                    <p class="mb-0 text-gray-300">© <script>
                        ...
                        </script> Congtiendev. Design with <i class="mdi mdi-heart text-red-600"></i> by <a href="https://shreethemes.in/" target="_blank" class="text-reset">Le Cong Tien</a>.</p>
                </div>
